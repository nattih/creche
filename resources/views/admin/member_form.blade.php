      ...
      <div id="content-wrapper" class="d-flex flex-column ">
        <div id="content ">
          ...
          <div class="container-fluid  " >
            ...
            <div class="card-header text-center font-weight-bold"> <i class="text-info fa fa-plus-circle" aria-hidden="true"></i>{{ __(' Nouveau personnel') }}</div>
                ...
                <form method="POST" id="agent_form" action=" " enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                          ...
                          <input type="date" class="form-control @error('naissance') is-invalid @enderror" type="text" name="naissance" placeholder="" value="{{ old('naissance') }}">
                            @error('naissance')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
