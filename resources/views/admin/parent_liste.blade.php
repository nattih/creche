            ...
            <div class="card">
              ...
              @endif
                <div class="card-header ">
                  ...
                  <h4 class="text-center">liste des parents</h4>
                </div>
                <div class="table table-responsive p-0 card-body">
                    <table id="example1" class="table table-hover   text-nowrap ">
                      ...
                      <tr>
                        ...
                        <td class="text-bold"> {{$parent->nom}} </td>
                        <td class="text-bold"> {{$parent->prenom}} </td>
                        <td class="text-bold"> {{$parent->telephone}} </td>
                        <td class="text-bold"> {{$parent->email}} </td>
                        <td class="text-bold"> {{$parent->cnib}} </td>
                        <td><img src="{{asset('storage').'/'.$parent->photo}}" style="width:50px;height:50px;" class="bf5 border rounded-circle "></td>
                        <td>{{$parent->statut}}  </td>
                        <td>
